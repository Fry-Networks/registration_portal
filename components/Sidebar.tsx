...
export default ({ completionStatus, isOpen, toggleSidebar, setCurrentSection, currentSection }: SidebarProps) => {
    return (
        <div
            className={`fixed top-0 left-0 z-50 h-full w-64 bg-gray-950 md:bg-transparent border-r border-white/10 p-4 text-white transform ${isOpen ? 'translate-x-0' : '-translate-x-full'
        ...
        >
            ...
            <div
                onClick={() => { setCurrentSection(0); toggleSidebar(); }}
            ...
            <div
                onClick={() => { setCurrentSection(1); toggleSidebar(); }}
            ...
            <div
                onClick={() => { setCurrentSection(2); toggleSidebar(); }}
                className={`flex items-center cursor-pointer ${currentSection === 2 ? 'bg-gray-800 p-2 rounded' : ''}`}
            >
                <span className="mr-2">
