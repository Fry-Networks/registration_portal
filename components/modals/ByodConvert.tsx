...
const ByodConvertModal: React.FC<ByodConvertModalProps> = ({
    ...
    const handleConvert = async () => {
        ...
        if (response.ok) {
            setUpdateSuccess({ status: 'success', message: 'Successfully converted your byod license' });
    ...
    return (
        ...
        >
            <DialogPanel className="sm:max-w-2xl">
                ...
                <Button onClick={handleConvert} disabled={byodLicense === '' || selectedProduct === '' || !/^[A-Z0-9]+$/.test(byodLicense)}>Convert</Button>
