...
export default function PasteAddress({ handlePaste }) {
  ...
  return (
    <div className="relative inline-block">
      <Flex
        flexDirection="row"
        className="w-auto gap-2 cursor-pointer hidden sm:block"
      ...
      <Flex
        flexDirection="row"
        className="w-auto gap-2 cursor-pointer block sm:hidden"
        onClick={() => handlePasteButton()}
      >
        <svg
          height="24"
