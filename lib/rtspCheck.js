...
// Export the function as the module itself for CommonJS default-import compatibility
module.exports = checkRtspLink;
// Also provide the named export for callers that require it explicitly
module.exports.checkRtspLink = checkRtspLink;
module.exports.default = checkRtspLink;
